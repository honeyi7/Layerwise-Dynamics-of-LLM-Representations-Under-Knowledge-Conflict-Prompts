...
jobname=check_logits_qwen2.5_3B_$(date +%Y%m%d_%H%M%S)
...
KNOW_DATA=main/knowledge_probe/result/qwen2.5_3B/known_bucket.jsonl
UNKNOWN_DATA=main/knowledge_probe/result/qwen2.5_3B/unknown_bucket.jsonl
AMBIGUOUS_DATA=main/knowledge_probe/result/qwen2.5_3B/ambiguous_bucket.jsonl
INTERVENTION_KIND=state 


OUTPUT_DIR=main/check_logits/results/qwen2.5_3B
